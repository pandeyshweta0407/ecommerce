    ...
    <div className=" container mx-auto px-4 py-5 lg:py-8">
        ...
        <div className="bottom">
            ...
            <div className="mx-auto my-4 max-w-6xl px-2 md:my-6 md:px-0">
                ...
                {/* main 2 */}
                <div className="mt-5 flex flex-col overflow-hidden border-2 border-neutral-400 rounded-3xl md:flex-row">
                    {/* main 3  */}
                    <div className="w-full border-2 border-neutral-400 rounded-3xl  bg-white md:max-w-xs">
                        {/* left  */}
                        <div className="p-8">
