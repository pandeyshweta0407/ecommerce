  ...
  return (
    <div>
            ...
            <div className="top mb-5 px-5 mt-5">
                <div className="py-5 bg-white p-8 border-2 border-neutral-400 rounded-3xl">
                ...
                <div className="">
                  ...
                  <TabList className="flex flex-wrap -m-4 text-center justify-center">
                        ...
                        <Tab className="p-4 md:w-1/3 sm:w-1/2 w-full cursor-pointer">
                            <div className=" bg-blue-gray-200 p-8 border-2 border-neutral-400 rounded-3xl hover:bg-blue-gray-700 " >
