  ...
  return ( 
    <div className='w-full h-full flex flex-col lg:flex-row flex-wrap items-center justify-center m-5'  >
       <div className="w-full lg:w-2/4 flex flex-col flex-wrap items-center justify-center  slideInRight">
            ...
            <div className=' text-1xl  xl:text-2xl text-pop-up-top mt-16 text-wrap text-blue-gray-300' >Fullfilling your all needs</div>
            <div className=' text-1xl  xl:text-2xl  text-wrap text-blue-gray-300' >Cash on Delivery</div>
       </div>
